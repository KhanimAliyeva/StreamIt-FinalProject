    ...
    public class MovieProfile : Profile
    {
        public MovieProfile()
        {
            ...
            CreateMap<Movie, GetMovieDto>()
                ...
                .ForMember(dest => dest.MovieStatistics, opt => opt.MapFrom(src => src.MovieStatistics));
            ...
            CreateMap<MovieStatistics, MovieStatisticsDto>();
