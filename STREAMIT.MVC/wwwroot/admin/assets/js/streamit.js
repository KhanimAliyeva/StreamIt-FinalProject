    ...
    $(document).ready(function () {
      if ($('[data-toggle="data-table1"]').length) {
        ...
        var searchWrapper = $(
          ...
          <div id="seasonTable_filter" class="dataTables_filter d-flex justify-content-space-between"> 
          <div class="d-flex gap-2"> 
        ...
        $('.dataTables_filter').not('#seasonTable_filter').remove();
        ...
        function showPagination() {
          $('[data-toggle="data-table1"]').parent().find('.dataTables_paginate ul.pagination').css({
            'opacity': '1',
            'position': 'relative'
          });
        }
